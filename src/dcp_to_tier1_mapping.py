...
DCP_TIER1_MAP = {
    """mapping between dcp and Tier 1 fields. comment out rows are edited in script"""
...
TIER1 = {
    "uns": ["title", "study_pi", "batch_condition", "default_embedding", "comments"],
    "obs": [
        "sample_id",
        "donor_id",
        "protocol_url",
...
COLLECTION_DICT = {
    "nasal brush": "brush",
    "tracheal brush": "brush",
    "breast milk collection": "body fluid",
    "urine collection": "body fluid",
    "oral rinse collection": "body fluid",
    "lavage": "body fluid",
    "lumbar puncture": "body fluid",
    "paracentesis": "body fluid",
    "bone marrow aspiration": "other",
    "collecting specimen from organ postmortem": "other",
    "cadaver dissection": "other",
    "curettage": "other",
    "oophorectomy": "other",
    "transvaginal ultrasound-guided oocyte retrieval": "other",
    "vacuum aspiration": "other",
    "dissection": "surgical resection",
    "immunosurgery": "surgical resection",
    "organ extraction": "surgical resection",
    "tonsillectomy": "surgical resection",
    "biopsy": "biopsy", 
